...
make an additional design change to our \ac{dafsa} representation that further
reduces its size.
...
We analso extend the design of prior work with \emph{path compaction}, which
...
resulted in a size savings of nearly 10\% of the original \ac{dafsa} size.
