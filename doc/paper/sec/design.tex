...
When establishing an HTTPS connection with a server,
...
\bp{TODO: The paper is inconsistent in describing log aggregation info;
          in some places we say the client gets it from the aggregator,
          in other places that the domain does and forwards to the client}
...
\bp{TODO: Need to cite TLS extensions for multiple certs~\cite{rfc-extra-cert-1,rfc-extra-cert-2}}
