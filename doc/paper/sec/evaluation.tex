...
Our results, shown in Figure~\ref{fig:evaltlsext}, show that there is
a some small latency overhead, mainly due to the extra data sent over
the network. However, since our \ac{tls} extension does not add any
extra round-trips to the handshake, the time added is small. \jay{[The
  null hypothesis on the Student's t-test says that the two
